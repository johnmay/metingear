...
/**
 * Compares to {@link org.openscience.cdk.geometry.cip.ILigand}s based on CIP sequences sub rules. The used CIP sub rules are:
 * <ol>
 *   <li>{@link org.openscience.cdk.geometry.cip.rules.MassNumberRule}</li>
 *   <li>{@link org.openscience.cdk.geometry.cip.rules.AtomicNumberRule}</li>
 * </ol>
 *
 * @cdk.module cip
 * @cdk.githash
