 ...
 */
public class BioMartReactomeMain {

    private static final String location = "http://www.reactome.org:5555/biomart/martservice";
    ...
    public static void main(String[] args) throws MartServiceException, ResultReceiverException {
        ...
        MartDataset dataset = service.getDataset("default", "pathway");
        MartQuery query = new MartQuery(service, dataset, "methodMatchQuery");

        // add filters
        query.addFilter(dataset.getName(), new Filter("pathway_id_list", "REACT_2232"));

        // add attributes
        query.addAttribute(dataset.getName(), new Attribute("_displayname"));
        ...
        service.executeQuery(q, new ResultReceiver() {
            ...
            public void receiveError(String error, long l) throws ResultReceiverException {
