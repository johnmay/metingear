...
/**
 * An undoable edit for add reactant participants.
 *
 * @author John May
 */
public class AddReactantEdit extends AbstractUndoableEdit {

    private final MetabolicReaction reaction;
    private final MetabolicParticipant participant;

    public AddReactantEdit(MetabolicParticipant participant,
