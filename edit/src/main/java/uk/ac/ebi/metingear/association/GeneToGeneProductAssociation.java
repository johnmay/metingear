...
/**
 * UndoableEdit to associate a gene with a gene product.
 *
 * @author John May
 */
public class GeneToGeneProductAssociation
    ...
    public GeneToGeneProductAssociation(Reconstruction reconstruction,
                                        Gene gene,
                                        GeneProduct product) {
