 ...
 * @author John May
 */
public class ReplaceMetaboliteEditTest {
    ...
    @Test public void testUndo() {
        ...
        Metabolite e = new MetaboliteImpl("e");

        ReplaceMetaboliteEdit edit = new ReplaceMetaboliteEdit(a, e, reconstruction);
        ...
        Assert.assertEquals(0, reconstruction.reactome().participatesIn(e).size());
