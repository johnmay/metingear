 ...
 * @author John May
 */
public class GeneToGeneProductAssociationTest {
    ...
    @Test public void apply() {
        ...
        AppliableEdit edit = new GeneToGeneProductAssociation(recon, gene, product);
    ...
    @Test public void redo() {
        ...
        verify(recon, times(2)).associate(gene, product);
    }
