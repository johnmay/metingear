 ...
 * @author John May
 */
public class AddReactantEditTest {
    ...
    public void testUndo() throws Exception {
        ...
        r1.addProduct(new MetabolicParticipantImplementation(b));

        UndoableEdit edit = new AddReactantEdit(new MetabolicParticipantImplementation(c), r1);

        r1.addReactant(new MetabolicParticipantImplementation(c));

        Assert.assertThat(r1.getReactantCount(), is(1));
        Assert.assertThat(r1.getReactants().get(0).getMolecule(), is(sameInstance(c)));
    ...
    public void testUndo_MultipleProducts() throws Exception {
        ...
        Assert.assertThat(r1.getReactantCount(), is(2));
        Assert.assertThat(r1.getReactants().get(0).getMolecule(), is(sameInstance(d)));
        Assert.assertThat(r1.getReactants().get(1).getMolecule(), is(sameInstance(c)));
    ...
    public void testRedo() throws Exception {
        ...
        Assert.assertThat(r1.getReactantCount(), is(1));
        Assert.assertThat(r1.getReactants().get(0).getMolecule(), is(c));
    ...
    public void testRedo_Multiple() throws Exception {
        ...
        Assert.assertThat(r1.getReactantCount(), is(2));
        Assert.assertThat(r1.getReactants().get(0).getMolecule(), is(d));
        Assert.assertThat(r1.getReactants().get(1).getMolecule(), is(c));
