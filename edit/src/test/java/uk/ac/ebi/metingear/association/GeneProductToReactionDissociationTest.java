 ...
 * @author John May
 */
public class GeneProductToReactionDissociationTest {
    ...
    @Test public void apply() {
        ...
        AppliableEdit edit = new GeneProductToReactionDissociation(recon, product, reaction);
    ...
    @Test public void redo() {
        ...
        verify(recon, times(2)).dissociate(product, reaction);
    }
