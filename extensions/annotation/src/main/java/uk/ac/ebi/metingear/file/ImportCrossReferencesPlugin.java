...
import uk.ac.ebi.metingear.tools.annotation.ExtractAnnotations;
...
/**
 * Plugin controller for the ImportCrossReferences dialog.
 *
 * @author John May
 * @see uk.ac.ebi.metingear.tools.annotation.ExtractReferences
 */
public class ImportCrossReferencesPlugin implements PlugableDialog {

    @Override
    public List<String> getMenuPath() {
        return Arrays.asList("File", "Import...");
    }

    @Override
    public Class<? extends ControlDialog> getDialogClass() {
        return ImportCrossReferences.class;
    }
