...
public class NonProductionMetabolites
    ...
    public NonProductionMetabolites(MainController controller) {
        super(NonProductionMetabolites.class.getSimpleName());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            Integer[] indices = gf.getUnproducedMetabolites();
