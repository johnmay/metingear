...
public class TerminalNonConsumptionMetabolites
    ...
    public TerminalNonConsumptionMetabolites(MainController controller) {
        super(TerminalNonConsumptionMetabolites.class.getSimpleName());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            StoichiometricMatrix<CompartmentalisedMetabolite, ?> s = (StoichiometricMatrix) active.getMatrix();
