...
/** @author John May */
public final class Pyranator extends ControllerDialog {
    ...
    public Pyranator(JFrame frame,
                     TargetedUpdate updater,
                     ReportManager messages,
                     SelectionController controller,
                     UndoableEditListener undoableEdits) {
        super(frame, updater, messages, controller, undoableEdits, "Pyranator");
    ...
    @Override public JLabel getDescription() {
        ...
        label.setText("Select open-chain compounds to convert to close-ring (pyranose) form");
        return label;
    }
