...
//    }
    ...
    private class ImportMenu extends JMenu {
        ...
        public ImportMenu() {
            ...
            super( "Import" );
            JMenu modelMenu = new JMenu( "Existing Model" );
            modelMenu.add( new DynamicMenuItem( new ImportSBMLAction() ) );
            modelMenu.add( new DynamicMenuItem( new ImportXLSAction() ) );
            add(modelMenu);
    ...
    private class ExportMenu extends JMenu {
        ...
        public ExportMenu() {
            ...
            add( new DynamicMenuItem( new ExportSBMLAction() ) );
        }
    }
}
